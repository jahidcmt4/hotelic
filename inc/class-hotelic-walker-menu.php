<?php
if (!class_exists('Hotelic_Custom_Nav_Walker')) {
class Hotelic_Custom_Nav_Walker extends Walker_Nav_Menu { 
	...
	public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) { 
		...
		$item_output .= (is_object($args) && $args->has_children) ? ' <div class="hotelic-dropdown"> ' : '';
		...
		$item_output .= '</a>';
		$item_output .= (is_object($args) && $args->has_children) ? ' <button class="toggle"><i class="fa fa-angle-down"></i></button> ' : '';
		$item_output .= (is_object($args) && $args->has_children) ? ' </div> ' : '';
